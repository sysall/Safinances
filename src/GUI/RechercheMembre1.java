...
public class RechercheMembre1 extends javax.swing.JFrame {

    public RechercheMembre1() {
        initComponents();
    }
        ...
        jButton1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton1ActionPerformed(evt);
    			  ...
    			  ChercherMembre.rechercher1(nom, prenom);
                  dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RechercheMembre1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
