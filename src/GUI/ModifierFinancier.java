...
public class ModifierFinancier extends javax.swing.JFrame {

   
    public ModifierFinancier() {
        initComponents();
    }
    ...
    private void initComponents() {
		...
		cnx.connecter();
        try {
        	String s = "SELECT * FROM Financier";
            ...
            while(myRs.next()) {
            	int	id = myRs.getInt("idFinancier");
				String nom =myRs.getString("nom_financier");
				String prenom = myRs.getString("prenom_financier");
				String login = myRs.getString("loginFinancier");
				String mdp = myRs.getString("mdpFinancier");
        ...
        jButton1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ...
                java.awt.EventQueue.invokeLater(new Runnable() {
                    public void run() {
                        new ModifierFinancier1(id,nom,prenom,login,mdp).setVisible(true);
                    }
                });
            }
        });
        ...
        jButton3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
        		...
        		cnx.connecter();
                Object id = jTable1.getValueAt(jTable1.getSelectedRow(),0);
                String s = "DELETE from Financier WHERE idFinancier='"+id+"'";
                cnx.executeUpdate(s);
                JOptionPane.showMessageDialog(null, "Suppression financier effectué!!! ");
				dispose();
				java.awt.EventQueue.invokeLater(new Runnable() {
		            public void run() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModifierFinancier.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
