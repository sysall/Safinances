...
import Metier.ConsulterRecette;

@SuppressWarnings("serial")
public class ConsulterRecettes extends javax.swing.JFrame {

    
    public ConsulterRecettes() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Consulter les Recettes");
        ...
        jCheckBox1.setText("Principale");

        jCheckBox2.setFont(new java.awt.Font("Ubuntu", 2, 18)); // NOI18N
        jCheckBox2.setText("Secondaire");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
    	...
    	if(jCheckBox1.isSelected()==true && jCheckBox3.isSelected()==true) {
        	...
        	java.awt.EventQueue.invokeLater(new Runnable() {
                public void run() {
                    new ConsPrincipal(date1,date2).setVisible(true);
                }
            });
            dispose();	
        }
        if(jCheckBox1.isSelected()==true && jCheckBox4.isSelected()==true){
        	String date1 = jTextField1.getText();
        	String date2 = jTextField2.getText();
          	String[][] data = ConsulterRecette.recettePrincipale(date1, date2);
			...
			try {
				...
				int i = 0;
				int j = 0;
				fluxEcriture.write(" recettes principale du "+date1+" au "+date2);
				fluxEcriture.write("\n");
				fluxEcriture.write("+---------------------+--------+------------+");
				fluxEcriture.write("\n");
				fluxEcriture.write("montant |date        |");
				fluxEcriture.write("\n");
				fluxEcriture.write("+---------------------+--------+------------+");
				fluxEcriture.write("\n");
        ...
        if(jCheckBox2.isSelected()==true && jCheckBox3.isSelected()==true) {
        	...
        	java.awt.EventQueue.invokeLater(new Runnable() {
                public void run() {
                    new ConsSecondaire(date1,date2).setVisible(true);
                }
            });
            dispose();	
        }
        if(jCheckBox2.isSelected()==true && jCheckBox4.isSelected()==true) {
        	String date1 = jTextField1.getText();
        	String date2 = jTextField2.getText();
          	String[][] data = ConsulterRecette.recetteSecondaire(date1, date2);
        	Writer fluxEcriture = null;
			try {
				JFileChooser fc = new JFileChooser();
				FileNameExtensionFilter filtre = new FileNameExtensionFilter("TXT file", "txt");
				...
				int i = 0;
				int j = 0;
				fluxEcriture.write(" recettes secondaires du "+date1+" au "+date2);
				fluxEcriture.write("\n");
				fluxEcriture.write("+---------------------+--------+------------+");
				fluxEcriture.write("\n");
				fluxEcriture.write("montant |date        |libellé     |Nom     |Prénom");
				fluxEcriture.write("\n");
				fluxEcriture.write("+---------------------+--------+------------+");
				fluxEcriture.write("\n");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsulterRecettes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
