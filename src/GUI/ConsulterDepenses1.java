...
public class ConsulterDepenses1 extends javax.swing.JFrame {

	private static final long serialVersionUID = 1L;
	
    public ConsulterDepenses1(String date1, String date2) {
	...
	private void initComponents(String date1, String date2) {
        ...
        try {
			...
			cnx.connecter();
        	String s = "SELECT sum(montant) as somme FROM DepenseEspece WHERE date BETWEEN '"+date1+"' AND '"+date2+"'";
        ...
        try {
        	...
        	String s = "SELECT * FROM DepenseEspece WHERE date BETWEEN '"+date1+"' AND '"+date2+"'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsulterDepenses1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
