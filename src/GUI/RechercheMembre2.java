...
public class RechercheMembre2 extends javax.swing.JFrame {

    
    public RechercheMembre2() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButton1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ...
                ChercherMembre.rechercher2(nom, prenom);
                dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RechercheMembre2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
