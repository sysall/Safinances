...
public class ConsulterRecettes1 extends javax.swing.JFrame {

  
    public ConsulterRecettes1() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
    	if(jCheckBox3.isSelected()==true) {
        	...
        	java.awt.EventQueue.invokeLater(new Runnable() {
                public void run() {
                    new ConsMembres(nom,prenom,date1,date2).setVisible(true);
                }
            });
            dispose();
        }
    	if(jCheckBox4.isSelected()== true) {
        	...
        	String date1 = jTextField1.getText();
        	String date2 = jTextField2.getText();
        	String[][] data = ConsulterRecette.RecetteMembre(nom, prenom, date1, date2);
			...
			try {
				...
				fluxEcriture.write("+---------------------+--------+------------+");
				fluxEcriture.write("\n");
				fluxEcriture.write("montant |date        |Nom     |Prénom     |Catégorie");
				fluxEcriture.write("\n");
				fluxEcriture.write("+---------------------+--------+------------+");
				fluxEcriture.write("\n");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsulterRecettes1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
