...
public class LoginAdmin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel3.setBackground(new java.awt.Color(242, 111, 118));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/GUI/login1.png"))); 
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        Connexion.connexionAdmin(login, password);
        dispose();
    }
